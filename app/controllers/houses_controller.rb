    ...
    def house_params
      ...
      :facility_ids => [],
		pricing_attributes: [:id, :n_people, :surcharge_night, :surcharge_week, :house_id, :note,
		  periods_attributes: [:id, :from, :to, :min, :min_type, :cost_per_night, :cost_per_week, :cost_add_week, :season, :pricing_id, :ptype, :cost_add_person, :cost_add_person_week, :_destroy],
